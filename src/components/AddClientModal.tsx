      ...
      <div className="bg-white rounded-[2.5rem] shadow-[0_25px_70px_rgba(0,0,0,0.3)] w-full max-w-md overflow-hidden border border-white/20 animate-in zoom-in duration-200">
        ...
        <div className="max-h-[80vh] overflow-y-auto custom-scrollbar">
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              {!initialData && (
                <>
                  <div className="col-span-2 flex items-center gap-3 py-2">
                    ...
                    <span className="text-[10px] font-black text-slate-300 uppercase tracking-[0.2em]">Автомобиль</span>
                    <div className="h-px bg-slate-100 flex-1"></div>
                  </div>
                  <div>
            ...
            <button type="submit" className="w-full bg-slate-950 text-white py-4 rounded-xl font-black uppercase text-[11px] tracking-[0.2em] hover:bg-green-600 transition-all shadow-lg active:scale-95 mt-2">
              Сохранить данные
            </button>
          </form>
        </div>
